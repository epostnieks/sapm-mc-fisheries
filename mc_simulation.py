#!/usr/bin/env python3
"""
SAPM Monte Carlo Simulation — Fisheries / Coral / External Forcing Impossibility
==================================================

Reproduces all quantitative results in:

  Postnieks, E. (2026). SAPM Working Paper: Fisheries / Coral (External Forcing Impossibility).
  Available: SSRN.
...
CONFIG = {
    "paper_id": "fisheries",
    "domain_name": "Fisheries / Coral",
    "theorem": "External Forcing Impossibility",
    "classification": "Class 1 \u2014 Impossibility",
    "seed": 42,
    "n_draws": 100000,
    "correlation_rho": 0.3,
    "private_payoff_B": 38.0,
    "channels": {
        "C1_stock_depletion": {
            "dist": "lognormal",
            "low": 51.0,
            ...
            "high": 105.0,
            "weight": 0.468,
            "description": "Foregone economic rent from overfishing beyond E_MSY. World Bank (2017) Arnason bioeconomic model: gap between actual ($3B/yr) and MEY ($86B/yr) profitability."
        },
        "C2_bycatch_discards": {
            "dist": "normal",
            "low": 10.0,
            ...
            "high": 20.0,
            "weight": 0.085,
            "description": "Lost commercial value of 38M tonnes bycatch/yr (WWF), premature fishery closures, reduced prey base. Excludes non-market existence values."
        },
        "C3_benthic_habitat_destruction": {
            ...
            "high": 42.0,
            "weight": 0.152,
            "description": "Bottom trawling habitat damage (Pristine Seas 2025: \u20ac11B/yr Europe, scaled globally) + conservative carbon externalities. Wide CI reflects Sala-Hiddink debate."
        },
        "C4_iuu_fishing": {
            "dist": "normal",
            "low": 10.0,
            ...
            "high": 24.0,
            "weight": 0.096,
            "description": "Ex-vessel value of IUU catch (Agnew et al. 2009: 11-26M tonnes, $10-23.5B). Theft from sovereign resources + organized crime nexus."
        },
        "C5_capacity_enhancing_subsidies": {
            ...
            "high": 26.0,
            "weight": 0.125,
            "description": "Direct fiscal transfer from Sumaila et al. (2019): $22.2B capacity-enhancing of $35.4B total. Excludes amplification effects (conservative)."
        },
        "C6_governance_forced_labor": {
            ...
            "high": 22.0,
            "weight": 0.074,
            "description": "ILO forced labor valuation + RFMO governance failure cost (gap between recommended and adopted measures). Wide CI reflects measurement challenges."
        }
    },
